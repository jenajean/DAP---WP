...
<nav class="main-nav">
		...
		<div id="sub-nav-wrap">
			<nav class="sub-nav about-sub-nav">
				<ul>
					<li class="first-sub-nav-item"><a href="http://www.davidandersenpianos.com/about">About Us</a></li>
					<li><a href="http://www.davidandersenpianos.com/about-heroes-and-mentors">Heroes and Mentors</a></li>
					<li><a href="http://www.davidandersenpianos.com/about-what-people-say" class="selected">What People Say</a></li>
				</ul>
			</nav>
		</div>
	</div>
	...
	<div id="dynamic-content-wrap">
		<div id="dynamic-content" class="group">
				<div class="side-nav-section">
						<nav class="side-nav">
							<div>
								<img src="http://www.davidandersenpianos.com/images/What-ppl-say-1.jpg" alt="" />
								<img src="http://www.davidandersenpianos.com/images/What-ppl-say-jonah.jpg" alt=""/>
							</div>
						</nav>
					</div>
