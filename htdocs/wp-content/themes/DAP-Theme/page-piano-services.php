...
<?php get_header(); the_post(); ?>
		...
		<div id="sub-nav-wrap">
			<nav class="sub-nav piano-services-sub-nav">
				<ul>
					<li class="first-sub-nav-item"><a href="http://www.davidandersenpianos.com/piano-services" class="selected">Piano Services</a></li>
					<li><a href="http://www.davidandersenpianos.com/piano-services-custom-restoration">Custom Restoration</a></li>
					<li><a href="http://www.davidandersenpianos.com/piano-services-things-you-should-know">Things you Should Know</a></li>
				</ul>
			</nav>
		</div>
	</div>
		...
		<div id="dynamic-content">
			...
			<div class="central-section">
				...
				<div class="static-content group">
					<img src="http://www.davidandersenpianos.com/images/David-working.jpg" alt="David Andersen tuning"/>
