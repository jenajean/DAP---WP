        ...
        playlistMgr = function() {
            ...
            markup = {
                listItem:'<li class="track">' +
                            ...
                            '<div class="button-float"><a href="#" class="buy not-active" target="_blank"></a>' +
							'<a href="#" class="buyy not-active" target="_blank"></a>' +
							'<a href="#" class="buyyy not-active" target="_blank"></a></div></div>' +
                        '</li>',
			...
			function setBuyyLink($track, index) {
                if (!isUndefined(myPlaylist[index].buyy)) {
                    $track.find(cssSelector.buyy).removeClass(attr(cssSelector.buyNotActive)).attr('href', myPlaylist[index].buyy).html(buyyText(index));
                }
            }
			
			function setBuyyyLink($track, index) {
                if (!isUndefined(myPlaylist[index].buyyy)) {
                    $track.find(cssSelector.buyyy).removeClass(attr(cssSelector.buyNotActive)).attr('href', myPlaylist[index].buyyy).html(buyyyText(index));
                }
            }
