        ...
        playlistMgr = function() {
            ...
            markup = {
                listItem:'<li class="track">' +
                            ...
                            '<div class="button-float"><?php if(get_option('buy_active')==1){ ?><a href="#" class="buy" target="_blank"></a><?php } ?>' +
							'<?php if(get_option('buyy_active')==1){ ?><a href="#" class="buyy" target="_blank"></a><?php } ?>' +
							'<?php if(get_option('buyyy_active')==1){ ?><a href="#" class="buyyy" target="_blank"></a><?php } ?></div></div>' +
                        '</li>',
